i want you to analyze our current ai chat in landing page and change it to the below content like conversation based, do not change the scroll animation just change the content inside the AI chat as follows: 
